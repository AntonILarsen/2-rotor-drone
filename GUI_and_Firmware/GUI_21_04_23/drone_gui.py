...
from ucamera import UCamera #MINE
...
class MainWindow(QtWidgets.QMainWindow):
  ...
  def __init__(self):
        ...
        self.camera =UCamera(self, self.ui) #MINE
        ...
        self.ui.actionCamera.changed.connect(self.menuViewCamera) #mine
        #
  ...
  def getIndex(self, tab):
    ...
    # if (tab <= 12):
    #   return i
    if (self.ui.actionCamera.isChecked()): #MINE
      i = i + 1
    if (tab <= 12):
      return i
  ...
  def menuViewCamera(self): #MINE
    self.menuShowTab(self.ui.actionCamera, 12, self.ui.tab_camera, "Camera") #MINE
  ...
  def menuViewShowAll(self):
    ...
    self.ui.actionCamera.setChecked(True) #MINE
  ...
  def menuViewHideMost(self):
    ...
    self.ui.actionCamera.setChecked(False) #MINE
  ...
  def menuSaveToIniFile(self):
    ...
    if self.main.isConnected() or True:
      ...
      config.set('menu', 'camera', str(self.ui.actionCamera.isChecked())) #MINE
  ...
  def loadFromIniFile(self):
    ...
    try:
      ...
      self.ui.actionCamera.setChecked(config.getboolean('menu', 'camera')) #MINE
...
# poseBridgeFile.close()
# print("poseBridgeFile has been closed")
