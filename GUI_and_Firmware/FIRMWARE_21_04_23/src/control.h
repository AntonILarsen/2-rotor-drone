...
//   UControlBase * ctrlYaw;
  // < CROSSCOUPLINGS:
  UControlBase * ctrlRoll2Pitch;
  UControlBase * ctrlRoll2Yaw;
  UControlBase * ctrlRoll2Height;
  
  UControlBase * ctrlPitch2Roll;
  UControlBase * ctrlPitch2Yaw;
  UControlBase * ctrlPitch2Height;
  
  UControlBase * ctrlYaw2Roll;
  UControlBase * ctrlYaw2Pitch;
  UControlBase * ctrlYaw2Height;

  UControlBase * ctrlHeight2Roll;
  UControlBase * ctrlHeight2Pitch;
  UControlBase * ctrlHeight2Yaw;
  // >
  //
